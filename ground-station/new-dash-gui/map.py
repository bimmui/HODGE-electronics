...
class DummyRocket:
    ...
    def __init__(self):
        self.time_series_data = {"Time": [], "Positions": [[37.7749, -122.4194],[38.749, -123.4194],[42, -130]],}  # start in San Fran for pos
...
def dashboard(rocket):
    ...
    def update_graph_live(n, positions):
        data = rocketo_proxy.get()
        

        #current_positions = data["Positions"]
        new_position = generate_new_position(positions[-1])
