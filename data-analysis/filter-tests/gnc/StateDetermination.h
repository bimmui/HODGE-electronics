...
#define SIGMA_GYRO 0.5
#define SIGMA_ACCEL 0.5
#define SIGMA_BARO 0.5
...
public:
    StateDeterminer();
    ~StateDeterminer();
    filter_estimates determineState(float accel_data[3], float gyro_data[3], float mag_data[3], float altitude, unsigned long curr_time);
